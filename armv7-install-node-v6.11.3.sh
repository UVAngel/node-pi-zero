...
wget https://nodejs.org/dist/$VERSION/node-$VERSION-linux-armv7l.tar.gz;
tar -xzf node-$VERSION-linux-armv7l.tar.gz;
# Remove the tar after extracing it.
sudo rm node-$VERSION-linux-armv7l.tar.gz;
# This line will clear existing nodejs
sudo rm -rf /opt/nodejs;
# This next line will copy Node over to the appropriate folder.
sudo mv node-$VERSION-linux-armv7l /opt/nodejs/;
